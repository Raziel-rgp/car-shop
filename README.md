...
<details>
  ...
  - Use o comando: `git clone https://github.com/tryber/sd-025-b-project-car-shop.git`.
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-025-b-project-car-shop/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-025-b-project-car-shop/pulls) e confira que o seu _Pull Request_ está criado
...
<details>
  ...
  Link: [Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH25-B&template=betrybe/sd-0x-project-car-shop)
